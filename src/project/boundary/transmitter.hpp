...
///The first segment is always high, the second segment is either high or low, 
///which determines the value of the bit. The final segment is always low.
...
public:
    ...
    ///@tparam class T has to be a class which implements the rtos::task<> template class,
    ///as the sleep function is used to produce the correct signal.
    ///@param bool bit is the bit that will be send. If bit is true,
    ///the function will put a high signal on the pin for 1600 microseconds
